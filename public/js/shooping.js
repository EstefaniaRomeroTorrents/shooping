const products = [
  {
    ...
    description:
      "Altura ajustable hasta 12,4 cm (en incrementos de 2,5 cm). Soporta hasta 20 kg. Los pies antideslizantes ayudan a mantener el soporte en su lugar",
    price: 1999,
    currency: "€",
  ...
  },
  {
    ...
    description:
      "Maletín compacto y poco voluminoso para tu portátil de hasta 17,3 pulgadas (43,94 cm). Con bolsillos para almacenar ratón, teléfono móvil y otros accesorios",
    price: 2549,
    currency: "€",
  ...
  },
  {
    ...
    description:
      "Ratón óptico inalámbrico con 3 botones y receptor USB-A nano para ordenador portátil, de sobremesa y netbook que permite un uso fluido y preciso a un bajo precio",
    price: 1399,
    currency: "€",
    photo:
      "https://m.media-amazon.com/images/I/61LtuGzXeaL._AC_CR0%2C0%2C0%2C0_SX704_SY660_.jpg",
  },
];
let totalCounter = 0;
  ...
  document.getElementById("list").innerHTML += `
        <div class="col-12 col-md-6 col-lg-4 col-xl-3 d-flex">
            <div class="card">
                ...
                <div class="card-body">
                    <a href="products.html?id=${i}" target="_blank"><h5 class="card-title">${
    item.title
  }</h5></a>
                    <a href="products.html?id=${i}" target="_blank"><p class="card-text block-ellipsis">${
    item.description
  }</p></a>
                    <span class="price">${item.price / 100} ${
    item.currency
  }</span>
